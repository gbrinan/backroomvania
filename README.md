---
name: backrooms-sprite-metroidvania
domain: other
start_year: 2026
status: active
owner: user
...
- 확정: 2D Sprite, 백룸 세계관, 메트로배니아, 마나 계열의 감성 참고, 파일 기반 계획, Git remote·push·PR.
- 현재 작업: 함께 논의할 기획 출발점. 게임 코드·아트·출시는 후속 범위다.
- 미정: 정확한 마나 작품, 시점, 플랫폼, 엔진, 팀·예산·기간, 공포·전투 비중, 백룸 설정의 채택 범위.
